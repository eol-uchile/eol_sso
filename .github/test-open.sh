...
DJANGO_SETTINGS_MODULE=lms.envs.test EDXAPP_TEST_MONGO_HOST=mongodb pytest -s -vvv --no-cov eol_sso/services/tests_eol_sso_login.py eol_sso/services/tests_eol_sso.py eol_sso/tests.py
